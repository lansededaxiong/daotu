...
class PortalClassificationModel extends Model
{
...
//        }
        ...
        foreach ($knowledges as $item) {
            ...
            $item['str_action'] = '<a href="' . url("AdminClassification/add", ["parent" => $item['id']]) . '">添加子知识点</a> | <a href="' . url("AdminClassification/edit", ["id" => $item['id']]) . '">' . lang('EDIT') . '</a> | <a class="js-ajax-delete" href="' . url("AdminClassification/delete", ["id" => $item['id']]) . '">' . lang('DELETE') . '</a> ';
            array_push($newKnowledges, $item);
        }
     ...
     * @return bool
     */
    public function editClassification($data)
    {
        $result = true;
