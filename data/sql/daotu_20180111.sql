...
-- 正在导出表  daotu.dd_admin_menu 的数据：~145 rows (大约)
...
REPLACE INTO `dd_admin_menu` (`id`, `parent_id`, `type`, `status`, `list_order`, `app`, `controller`, `action`, `param`, `name`, `icon`, `remark`) VALUES
	...
	(94, 5, 1, 0, 20, 'admin', 'Theme', 'index', '', '模板管理', '', '模板管理'),
	...
	(158, 119, 1, 1, 10000, 'Portal', 'Knowledge', 'default', '', '知识库管理', '', ''),
	(159, 119, 1, 1, 10000, 'Portal', 'AdminExamSet', 'index', '', '套题管理', '', ''),
	(160, 158, 1, 1, 10000, 'portal', 'AdminClassification', 'index', '', '知识点分类', '', ''),
	(161, 158, 1, 1, 10000, 'portal', 'AdminKnowledge', 'index', '', '知识点', '', '');
...
-- 正在导出表  daotu.dd_auth_rule 的数据：~156 rows (大约)
...
REPLACE INTO `dd_auth_rule` (`id`, `status`, `app`, `type`, `name`, `param`, `title`, `condition`) VALUES
	...
	(158, 1, 'Portal', 'admin_url', 'Portal/Knowledge/default', '', '知识库管理', ''),
	(159, 1, 'Portal', 'admin_url', 'Portal/AdminPoint/index', '', '公式管理', ''),
	(160, 1, 'Portal', 'admin_url', 'Portal/AdminExamSet/index', '', '套题管理', ''),
	(161, 1, 'portal', 'admin_url', 'portal/AdminClassification/index', '', '知识点分类', ''),
	(162, 1, 'portal', 'admin_url', 'portal/AdminKnowledge/index', '', '知识点', '');
...
CREATE TABLE IF NOT EXISTS `dd_portal_category` (
  ...
  `delete_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '删除时间',
  `list_order` float NOT NULL DEFAULT '10000' COMMENT '排序',
  `name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '章节名称',
  `description` text NOT NULL COMMENT '章节描述',
  `path` varchar(255) NOT NULL DEFAULT '' COMMENT '分类层级关系路径',
  `more` varchar(150) DEFAULT NULL COMMENT '扩展属性',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='portal应用 试题章节分类表';
...
CREATE TABLE IF NOT EXISTS `dd_portal_category_exam` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `exam_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '知识点id',
  `category_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '分类id',
  `list_order` float NOT NULL DEFAULT '0' COMMENT '排序',
  `status` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '状态,1:发布;0:不发布',
  PRIMARY KEY (`id`),
  KEY `term_taxonomy_id` (`category_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='portal应用 知识点知识分类对应表';
...
-- 正在导出表  daotu.dd_portal_category_post 的数据：~2 rows (大约)
/*!40000 ALTER TABLE `dd_portal_category_post` DISABLE KEYS */;
REPLACE INTO `dd_portal_category_post` (`id`, `post_id`, `category_id`, `list_order`, `status`) VALUES
	(1, 1, 1, 10000, 1),
	(2, 2, 2, 10000, 1);
/*!40000 ALTER TABLE `dd_portal_category_post` ENABLE KEYS */;


-- 导出  表 daotu.dd_portal_classification 结构
CREATE TABLE IF NOT EXISTS `dd_portal_classification` (
  ...
  `more` text COMMENT '扩展属性',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='portal应用 知识点分类表';

-- 正在导出表  daotu.dd_portal_classification 的数据：~2 rows (大约)
/*!40000 ALTER TABLE `dd_portal_classification` DISABLE KEYS */;
REPLACE INTO `dd_portal_classification` (`id`, `parent_id`, `status`, `delete_time`, `list_order`, `name`, `description`, `path`, `more`) VALUES
	(1, 0, 1, 0, 0, 'classification1', 'test', '0-1', '{"thumbnail":""}'),
	(2, 1, 1, 0, 0, 'classification2', 'testsafsdfsfsdfs', '0-1-2', '{"thumbnail":""}'),
	(3, 0, 1, 0, 0, 'classification3', 'test', '0-3', '{"thumbnail":""}');
/*!40000 ALTER TABLE `dd_portal_classification` ENABLE KEYS */;


-- 导出  表 daotu.dd_portal_classification_knowledge 结构
CREATE TABLE IF NOT EXISTS `dd_portal_classification_knowledge` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `knowledge_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '试题id',
  `classification_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '分类id',
  `list_order` float NOT NULL DEFAULT '0' COMMENT '排序',
  `status` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '状态,1:发布;0:不发布',
  PRIMARY KEY (`id`),
  KEY `term_taxonomy_id` (`classification_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='portal应用 知识点试题对应表';

-- 正在导出表  daotu.dd_portal_classification_knowledge 的数据：~2 rows (大约)
/*!40000 ALTER TABLE `dd_portal_classification_knowledge` DISABLE KEYS */;
REPLACE INTO `dd_portal_classification_knowledge` (`id`, `knowledge_id`, `classification_id`, `list_order`, `status`) VALUES
	(1, 1, 1, 0, 1),
	(5, 3, 0, 0, 1),
	(6, 3, 3, 0, 1);
/*!40000 ALTER TABLE `dd_portal_classification_knowledge` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `dd_portal_exam_set` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='portal应用 套题表';

-- 正在导出表  daotu.dd_portal_exam_set 的数据：~2 rows (大约)
...
REPLACE INTO `dd_portal_exam_set` (`id`, `name`, `create_time`, `delete_time`, `list_order`, `status`) VALUES
	(5, '卷一', 1510810921, 1510813801, 0, 1),
	(6, '卷二', 1510811757, 0, 1, 1);
...
CREATE TABLE IF NOT EXISTS `dd_portal_knowledge` (
  ...
  `more` text COMMENT '扩展属性',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='portal应用 知识点表';

-- 正在导出表  daotu.dd_portal_knowledge 的数据：~2 rows (大约)
/*!40000 ALTER TABLE `dd_portal_knowledge` DISABLE KEYS */;
REPLACE INTO `dd_portal_knowledge` (`id`, `create_time`, `update_time`, `delete_time`, `list_order`, `name`, `description`, `content`, `status`, `more`) VALUES
	(1, 1509356848, 1509356848, 0, 0, 'knowledge1', 'test', 'test', 1, NULL),
	(2, 0, 0, 0, 0, 'knowledge4', '', 'test', 1, NULL),
	(3, 1509356848, 1514275230, 0, 0, 'knowledge4', '', 'testtest', 1, NULL);
...
-- 正在导出表  daotu.dd_portal_post 的数据：~2 rows (大约)
/*!40000 ALTER TABLE `dd_portal_post` DISABLE KEYS */;
REPLACE INTO `dd_portal_post` (`id`, `parent_id`, `post_type`, `post_format`, `user_id`, `post_status`, `comment_status`, `is_top`, `recommended`, `post_hits`, `post_like`, `comment_count`, `create_time`, `update_time`, `published_time`, `delete_time`, `post_title`, `post_keywords`, `post_excerpt`, `post_source`, `post_content`, `post_content_filtered`, `more`) VALUES
	(1, 0, 1, 1, 1, 1, 1, 0, 1, 2, 0, 0, 1509356848, 1509356848, 1509356848, 0, 'test', 'test', 'test', 'test', 'test', 'tset', 'test'),
	(2, 0, 1, 1, 1, 1, 1, 0, 1, 1, 0, 0, 1511765464, 1511765464, 1511765432, 0, 'test', 'test', 'test', 'test', '&lt;p&gt;test&lt;/p&gt;', 'tset', 'test');
...
CREATE TABLE IF NOT EXISTS `dd_portal_tag` (
  ...
  `status` int(11) DEFAULT '1' COMMENT '状态，1启用，0禁用',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='portal应用 文章标签表';
...
REPLACE INTO `dd_portal_tag` (`id`, `name`, `create_time`, `delete_time`, `status`) VALUES
	(1, 'key1', 1510810921, 0, 1),
	(2, 'key2', 1510810921, 0, 1),
	(3, 'key3', 1510810921, 0, 1),
	(4, 'key4', 1510810921, 0, 1),
	(5, 'exam1', 1510810921, 0, 1);
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='portal应用 标签试题对应表';
...
REPLACE INTO `dd_portal_tag_post` (`id`, `tag_id`, `post_id`, `status`) VALUES
	(1, 1, 2, 1);
...
-- 正在导出表  daotu.dd_route 的数据：~0 rows (大约)
...
-- 正在导出表  daotu.dd_theme_file 的数据：13 rows
...
REPLACE INTO `dd_theme_file` (`id`, `is_public`, `list_order`, `theme`, `name`, `action`, `file`, `description`, `more`, `config_more`, `draft_more`) VALUES
	(107, 0, 5, 'simpleboot3', '首页', 'portal/Index/index', 'portal/index', '首页模板文件', '{"vars":[],"widgets":{"cate_list":{"title":"\\u8bd5\\u9898\\u5206\\u7c7b\\u5217\\u8868","display":"1","vars":[]}}}', '{"vars":[],"widgets":{"cate_list":{"title":"\\u8bd5\\u9898\\u5206\\u7c7b\\u5217\\u8868","display":"1","vars":[]}}}', NULL),
	(123, 0, 10, 'simpleboot3', '试题列表页', 'portal/List/index', 'portal/list_cat', '试题列表模板文件，按章节分类', '{"vars":[],"widgets":{"exam_list":{"title":"\\u8bd5\\u9898\\u5217\\u8868","display":"1","vars":{"exam_category_id":{"title":"\\u8bd5\\u9898\\u5206\\u7c7bID","value":"","type":"text","dataSource":{"api":"portal\\/category\\/index","multi":true},"placeholder":"\\u8bf7\\u9009\\u62e9\\u5206\\u7c7b","tip":"","rule":{"require":true}}}},"exam_category":{"title":"\\u7ae0\\u8282\\u5206\\u7c7b","display":"1","vars":{"exam_category_id":{"title":"\\u8bd5\\u9898\\u5206\\u7c7bID","value":"","type":"text","dataSource":{"api":"portal\\/category\\/index","multi":true},"placeholder":"","tip":"","rule":{"require":true}}}},"exam_set":{"title":"\\u5957\\u9898","display":"1","vars":{"exam_set_id":{"title":"\\u6587\\u7ae0\\u5206\\u7c7bID","value":"","type":"text","dataSource":{"api":"portal\\/set\\/index","multi":true},"placeholder":"","tip":"","rule":{"require":true}}}}}}', '{"vars":[],"widgets":{"exam_list":{"title":"\\u8bd5\\u9898\\u5217\\u8868","display":"1","vars":{"exam_category_id":{"title":"\\u8bd5\\u9898\\u5206\\u7c7bID","value":"","type":"text","dataSource":{"api":"portal\\/category\\/index","multi":true},"placeholder":"\\u8bf7\\u9009\\u62e9\\u5206\\u7c7b","tip":"","rule":{"require":true}}}},"exam_category":{"title":"\\u7ae0\\u8282\\u5206\\u7c7b","display":"1","vars":{"exam_category_id":{"title":"\\u8bd5\\u9898\\u5206\\u7c7bID","value":"","type":"text","dataSource":{"api":"portal\\/category\\/index","multi":true},"placeholder":"","tip":"","rule":{"require":true}}}},"exam_set":{"title":"\\u5957\\u9898","display":"1","vars":{"exam_set_id":{"title":"\\u6587\\u7ae0\\u5206\\u7c7bID","value":"","type":"text","dataSource":{"api":"portal\\/set\\/index","multi":true},"placeholder":"","tip":"","rule":{"require":true}}}}}}', NULL),
	(122, 0, 10, 'simpleboot3', '试题列表页', 'portal/List/exam_set', 'portal/list_set', '试题列表模板文件，套题分类', '{"vars":[],"widgets":{"exam_list":{"title":"\\u8bd5\\u9898\\u5217\\u8868","display":"1","vars":{"exam_category_id":{"title":"\\u8bd5\\u9898\\u5206\\u7c7bID","value":"","type":"text","dataSource":{"api":"portal\\/category\\/index","multi":true},"placeholder":"\\u8bf7\\u9009\\u62e9\\u5206\\u7c7b","tip":"","rule":{"require":true}}}},"exam_category":{"title":"\\u7ae0\\u8282\\u5206\\u7c7b","display":"1","vars":{"exam_category_id":{"title":"\\u8bd5\\u9898\\u5206\\u7c7bID","value":"","type":"text","dataSource":{"api":"portal\\/category\\/index","multi":true},"placeholder":"","tip":"","rule":{"require":true}}}},"exam_set":{"title":"\\u5957\\u9898","display":"1","vars":{"exam_set_id":{"title":"\\u6587\\u7ae0\\u5206\\u7c7bID","value":"","type":"text","dataSource":{"api":"portal\\/set\\/index","multi":true},"placeholder":"","tip":"","rule":{"require":true}}}}}}', '{"vars":[],"widgets":{"exam_list":{"title":"\\u8bd5\\u9898\\u5217\\u8868","display":"1","vars":{"exam_category_id":{"title":"\\u8bd5\\u9898\\u5206\\u7c7bID","value":"","type":"text","dataSource":{"api":"portal\\/category\\/index","multi":true},"placeholder":"\\u8bf7\\u9009\\u62e9\\u5206\\u7c7b","tip":"","rule":{"require":true}}}},"exam_category":{"title":"\\u7ae0\\u8282\\u5206\\u7c7b","display":"1","vars":{"exam_category_id":{"title":"\\u8bd5\\u9898\\u5206\\u7c7bID","value":"","type":"text","dataSource":{"api":"portal\\/category\\/index","multi":true},"placeholder":"","tip":"","rule":{"require":true}}}},"exam_set":{"title":"\\u5957\\u9898","display":"1","vars":{"exam_set_id":{"title":"\\u6587\\u7ae0\\u5206\\u7c7bID","value":"","type":"text","dataSource":{"api":"portal\\/set\\/index","multi":true},"placeholder":"","tip":"","rule":{"require":true}}}}}}', NULL),
	(119, 0, 10, 'simpleboot3', '试题页', 'portal/Examination/index', 'portal/examination', '试题页模板文件', '{"vars":[]}', '{"vars":[]}', NULL),
...
REPLACE INTO `dd_user` (`id`, `user_type`, `sex`, `birthday`, `last_login_time`, `score`, `coin`, `create_time`, `user_status`, `user_login`, `user_pass`, `user_nickname`, `user_email`, `user_url`, `avatar`, `signature`, `last_login_ip`, `user_activation_key`, `mobile`) VALUES
	(1, 1, 0, 0, 1515650755, 0, 0, 1505549527, 1, 'admin', '###0dd698cfcfa50c3d290adad76590d0e4', 'admin', 'admin@qq.com', '', '', '', '127.0.0.1', '', '');
...
REPLACE INTO `dd_user_token` (`id`, `user_id`, `expire_time`, `create_time`, `token`, `device_type`) VALUES
	(3, 1, 1531202755, 1515650755, '2ecfba48c0d0b32dcb99d42ab67dcf942ecfba48c0d0b32dcb99d42ab67dcf94', 'web');
